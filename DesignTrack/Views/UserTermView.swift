                ...
                VStack(alignment: .leading) {
                    VStack{
                        Image("DesignTrack")
                            ...
                            .scaledToFill()
                        Text("""
Você tem cada peça do seu projeto do seu projeto na palma da sua mão.
...
""")
                    ...
                    Text("""
                         ...
                         Ao acessar   utilizar o aplicativo, você concorda em cumprir e estar vinculado a estes Termos. Caso não concorde, não utilize o aplicativo.
...
5. Contato
Se você tiver dúvidas sobre esta Política de Privacidade ou precisar de mais informações, entre em contato conosco por meio de henrique.leal135@gmail.com ou meio de contato].
""")
